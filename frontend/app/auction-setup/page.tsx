      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600">
            Save the auction rules, define the teams and captains, and upload the current player pool before the live auction starts. Captains linked here are retained automatically, so they do not need to be bought later.
          </p>
        </div>

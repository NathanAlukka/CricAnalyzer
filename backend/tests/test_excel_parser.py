...
def test_parse_batting_excel_detects_header_after_title_rows() -> None:
    dataframe = pd.DataFrame(
        [
            ["Willows Premier League Batting", None, None, None, None],
            ["Season Summary", None, None, None, None],
            ["Player", "Mat", "Avg", "SR", "4s"],
            ["Virat Kohli", 10, 45.5, 140.2, 20],
            ["AB de Villiers", 8, 39.0, 151.6, 15],
        ]
    )
...
def test_parse_batting_excel_handles_formatted_header_labels() -> None:
    dataframe = pd.DataFrame(
        [
            ["All Series Batting Records - Willows Premier League", None, None, None, None],
            ["Player\u00a0", "Mat\u00a0", "Avg\u00a0", "SR\u00a0", "4's\u00a0"],
            ["Virat Kohli", 10, 45.5, 140.2, 20],
        ]
    )
